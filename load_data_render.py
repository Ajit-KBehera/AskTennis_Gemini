...
def create_database_with_players():
    ...
    rankings_df = pd.DataFrame()  # Initialize empty DataFrame since rankings loading is disabled
    ...
    doubles_df = pd.DataFrame()  # Initialize empty DataFrame since doubles loading is disabled
