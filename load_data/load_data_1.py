...
def load_matches_data():
    ...
    # Add era classification for all matches (create column if it doesn't exist)
    if 'era' not in matches_df.columns:
        matches_df['era'] = 'Professional'  # Default to professional era
    else:
        matches_df['era'] = matches_df['era'].fillna('Professional')  # Fill missing values
    
    # Add tournament type classification for all matches (create column if it doesn't exist)
    if 'tournament_type' not in matches_df.columns:
        matches_df['tournament_type'] = 'Main_Tour'  # Default to main tour
    else:
        matches_df['tournament_type'] = matches_df['tournament_type'].fillna('Main_Tour')  # Fill missing values
