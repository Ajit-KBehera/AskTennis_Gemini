...
LOAD_AMATEUR_MATCHES = True         # Amateur tennis data (1877-1967)
...
CREATE_TABLE_DOUBLES = True          # Create doubles_matches table
...
CREATE_INDEXES_DOUBLES = True       # Create indexes for doubles_matches table
