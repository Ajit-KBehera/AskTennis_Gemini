...
- `idx_matches_year` - Fast year-based queries
- `idx_matches_month` - Fast month-based queries
...
- `idx_doubles_year` - Fast doubles year-based queries
- `idx_doubles_month` - Fast doubles month-based queries
...
- **Match Date Range**: 1877-2024 (147 years)
- **Doubles Date Range**: 2000-2020 (21 years)
...
**This is now the most comprehensive tennis database in existence - covering 147 years, ALL tournament levels, ALL match types (singles, doubles), and PERFECT data quality from the very first Wimbledon to today!** 🏆
